...
define([
    ...
    $.widget('mage.addWiseExampleToCart', {
        options: {
            processStart: null,
            processStop: null,
            bindSubmit: true,
        ...
        enableAddToCartButton: function (form) {
            var addToCartButtonTextAdded = this.options.addToCartButtonTextAdded || $t('Example Added'),
                self = this,
                addToCartButton = $(form).find(this.options.addToCartButtonSelector);
            ...
            setTimeout(function () {
                var addToCartButtonTextDefault = self.options.addToCartButtonTextDefault || $t('Add Example to Cart');
    ...
    return $.mage.addWiseExampleToCart;
});
